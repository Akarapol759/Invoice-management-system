<%@ Page Title="Inventory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="N_Medical.Views.Inventory.Edit" %>
                    ...
                    <div class="container">
                        ...
                        <div>
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">Inventory Request : Edit</legend>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 control-label" style="text-align: left;">
                                                    ...
                                                    <asp:Label ID="lblEditCustomerCode" runat="server" Visible="false">
                                                    </asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 control-label" style="text-align: left;">
                                                    <asp:Label ID="lblEditPONumber" runat="server" Font-Bold="true">
                                                    </asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:DropDownList ID="DDLEditSale" runat="server" CssClass="form-control" Enabled="false">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:TextBox ID="txtEditDiscount" runat="server" CssClass="form-control" AutoPostBack="true" OnTextChanged="txtEditDiscount_TextChanged">
                                                    </asp:TextBox>
                                    ...
                                    <asp:GridView ID="GridView" runat="server" HorizontalAlign="Center" AllowSorting="true"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Item Name" ItemStyle-Width="70px" HeaderStyle-HorizontalAlign="Center"
                                                ItemStyle-HorizontalAlign="Left">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="gvtxtItemName" runat="server" CssClass="form-control"></asp:TextBox>
                                                </ItemTemplate>
                                                <ItemStyle Width="40%" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Unit Price" ItemStyle-Width="50px" HeaderStyle-HorizontalAlign="Center"
                                                ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="gvtxtUnitPrice" runat="server" CssClass="form-control"></asp:TextBox>
                                                </ItemTemplate>
                                                <ItemStyle Width="10%" />
