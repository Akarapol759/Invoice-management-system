...
namespace N_Medical.Views.Inventory
{
    public partial class Detail : System.Web.UI.Page
    {
        ...
        {
            DataTable data = oINVENTORY_Service.invoiceEditData(lblDetailId.Text);
            ReportViewer1.Reset();
            ...
            if(chkThai.Checked)
            {
                ...
                {
                    ReportViewer1.LocalReport.ReportPath = @"Reports\Thai\Inventory\Invoice\Invoice_ExcDateExcVat.rdlc";
                }
                else if (!chkNoDate.Checked && chkNoVat.Checked)
                {
                    ReportViewer1.LocalReport.ReportPath = @"Reports\Thai\Inventory\Invoice\Invoice_ExcVat.rdlc";
                }
                else if (chkNoDate.Checked && !chkNoVat.Checked)
                {
                    ReportViewer1.LocalReport.ReportPath = @"Reports\Thai\Inventory\Invoice\Invoice_ExcDate.rdlc";
                }
                else
                {
                    ReportViewer1.LocalReport.ReportPath = @"Reports\Thai\Inventory\Invoice\Invoice.rdlc";
                }
            }
            else
            {
                if (chkNoDate.Checked && chkNoVat.Checked)
                {
                    ReportViewer1.LocalReport.ReportPath = @"Reports\Inventory\Invoice\Invoice_ExcDateExcVat.rdlc";
                    
                }
                else if (!chkNoDate.Checked && chkNoVat.Checked)
                {
                    ReportViewer1.LocalReport.ReportPath = @"Reports\Inventory\Invoice\Invoice_ExcVat.rdlc";
                }
                else if (chkNoDate.Checked && !chkNoVat.Checked)
                {
                    ReportViewer1.LocalReport.ReportPath = @"Reports\Inventory\Invoice\Invoice_ExcDate.rdlc";
                }
                else
                {
                    ReportViewer1.LocalReport.ReportPath = @"Reports\Inventory\Invoice\Invoice.rdlc";
