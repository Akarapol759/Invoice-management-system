...
namespace N_Medical.Views.Inventory
{
    public partial class Main : System.Web.UI.Page
    {
        ...
        {
            ViewState["ReqData"] = oINVENTORY_Service.getData("I");
        ...
        {
            IEnumerable<DataRow> query = from i in oINVENTORY_Service.getDataSearch("I").AsEnumerable()
                                         select i;
            if (query.Any())
            {
        ...
        protected void GridView_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("detail"))
            {
                ...
                {
                    Response.Redirect("/Views/Inventory/Detail.aspx?id=" + GridView.DataKeys[index].Value.ToString());
                }
                else
                {
                    Response.Redirect("/Views/Inventory/Edit.aspx?id=" + GridView.DataKeys[index].Value.ToString());
                }
            }
        }
    }
