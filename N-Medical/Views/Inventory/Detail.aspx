<%@ Page Title="Inventory" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Detail.aspx.cs" Inherits="N_Medical.Views.Inventory.Detail" %>
                    ...
                    <div class="container">
                        ...
                        <div>
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">Inventory Request : Detail</legend>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 control-label" style="text-align: left;">
                                                    ...
                                                    <asp:Label ID="lblDetailId" runat="server" Visible="true">
                                                    </asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 control-label" style="text-align: left;">
                                                    <asp:Label ID="lblDetailDepartment" runat="server" Font-Bold="true">
                                                    </asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                <asp:Label runat="server" Text="Invoice Date : " CssClass="col-md-5 control-label"></asp:Label>
                                                <div class="col-md-7 control-label" style="text-align: left;">
                                                    <asp:Label ID="lblDetailInvoiceDate" runat="server" Font-Bold="true">
                                                    </asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 control-label" style="text-align: left;">
                                                    <asp:Label ID="lblDetailShipping" runat="server" Font-Bold="true">
                                                    </asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 control-label" style="text-align: left;">
                                                    <asp:Label ID="lblDetailDeliveryRoute" runat="server" Font-Bold="true">
                                                    </asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 control-label" style="text-align: left;">
                                                    <asp:Label ID="lblDetailWarehouse" runat="server" Font-Bold="true">
                                                    </asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 control-label" style="text-align: left;">
                                                    <asp:Label ID="lblDetailTotalAmount" runat="server" Font-Bold="true">
                                                    </asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 control-label" style="text-align: left;">
                                                    <asp:Label ID="lblDetailVat" runat="server" Font-Bold="true">
                                                    </asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7 control-label" style="text-align: left;">
                                                    <asp:Label ID="lblDetailTotalAmountIncVat" runat="server" Font-Bold="true">
                                                    </asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-12" style="text-align: center;">
                                                ...
                                                &nbsp;
                                                <asp:CheckBox ID="chkThai" runat="server" Text="Thai Numeric" />
                                            </div>
                                            <div class="col-md-12" style="text-align: center;">
                                                <asp:Button ID="btnPrint" runat="server" Text="Print" CssClass="btn btn-info" OnClick="btnPrint_Click" OnClientClick="target = '_blank';"/>
                                                &nbsp;
                                                <asp:Button ID="btnCreditNote" runat="server" Text="Credit Note" CssClass="btn btn-info" OnClick="btnCreditNote_Click" OnClientClick="return confirm('Do you want credit note request?');" />
                                                &nbsp;
