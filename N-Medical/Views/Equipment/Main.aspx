<%@ Page Title="Equipment" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="N_Medical.Views.Equipment.Main" %>
                    ...
                    <div class="container">
                        ...
                        <div>
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">Equipment Criteria : Search</legend>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:DropDownList ID="DDLINVStatus" runat="server" CssClass="form-control">
