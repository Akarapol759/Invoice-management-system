<%@ Page Title="Department Master" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="N_Medical.Views.Master.Department.Edit" %>
                            ...
                            <fieldset class="scheduler-border">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:TextBox ID="txtAddDepartmentCode" runat="server" CssClass="form-control">
                                                    </asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:TextBox ID="txtAddDepartmentName" runat="server" CssClass="form-control">
                                                    </asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-horizontal">
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-12" style="text-align: center;">
                                                <asp:Button ID="btnAddDepartment" runat="server" Text="Add" CssClass="btn btn-info" OnClick="btnAddDepartment_Click" OnClientClick="return confirm('Do you want add new department?');" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel" runat="server">
                                        <ContentTemplate>
                                            <asp:GridView ID="GridView" runat="server" HorizontalAlign="Center" PageSize="10" Width="100%"
                                                ...
                                                DataKeyNames="Dept_Code" CssClass="table table-striped table-bordered table-hover footable"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Dept_Code" HeaderText="Department Code" SortExpression="Dept_Code" />
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close"
                                        ...
                                        ×</button>
                                    <h3 id="editModalLabel">Edit Department</h3>
                                </div>
                                <div class="modal-body">
                                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                        <ContentTemplate>
                                            <div>
                                                <fieldset class="scheduler-border">
                                                    <legend class="scheduler-border">Edit Department</legend>
                                                    <div class="form-horizontal">
                                                        <div class="row">
                                                            <div class="col-sm-6 col-lg-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-7">
                                                                        ...
                                                                        <asp:Label ID="lblEditDepartmentCode" runat="server" Visible="false"></asp:Label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6 col-lg-6">
