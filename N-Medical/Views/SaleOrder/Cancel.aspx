<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Cancel.aspx.cs" Inherits="N_Medical.Views.SaleOrder.Cancel" %>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <asp:RadioButtonList ID="RdSaleOrderStatus" runat="server" RepeatDirection="Horizontal" Enabled="false">
                                                        <asp:ListItem Text="Cancel" Value="N" Selected="True"></asp:ListItem>
                                                    </asp:RadioButtonList>
                                                </div>
                                            </div>
                                        </div>
