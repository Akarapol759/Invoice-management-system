...
namespace N_Medical.Views.CreditNote
{
    public partial class Detail : System.Web.UI.Page
    {
        ...
        protected void BindData(string id)
        {
            ...
            lblDetailCreditNoteNumber.Text = reqData.Rows[0]["CreditNote_Number"].ToString();
            lblDetailCreditNoteDate.Text = reqData.Rows[0]["CreditNote_Date"].ToString();
            ...
            lblDetailInvoiceType.Text = reqData.Rows[0]["Invoice_Type_Name"].ToString();
            txtDetailRemark.Text = reqData.Rows[0]["CreditNote_Remark"].ToString();
            lblDetailDiscount.Text = reqData.Rows[0]["Invoice_Discount"].ToString();
            lblDetailStatus.Text = reqData.Rows[0]["Status_Name"].ToString();
        ...
        {
            DataTable data = oCREDITNOTE_Service.creditNoteDetail(lblDetailId.Text);
            ReportViewer1.Reset();
            ReportDataSource dt = new ReportDataSource("DataSet1", data);
            ReportViewer1.LocalReport.DataSources.Clear();
            ReportViewer1.LocalReport.DataSources.Add(dt);
            if (lblDetailInvoiceType.Text == "Equipment")
            {
                if (chkNoDate.Checked && chkNoVat.Checked)
                {
                    ReportViewer1.LocalReport.ReportPath = @"Reports\Equipment\CreditNote\Invoice_ExcDateExcVat.rdlc";
                }
                else if (!chkNoDate.Checked && chkNoVat.Checked)
                {
                    ReportViewer1.LocalReport.ReportPath = @"Reports\Equipment\CreditNote\Invoice_ExcVat.rdlc";
                }
                else if (chkNoDate.Checked && !chkNoVat.Checked)
                {
                    ReportViewer1.LocalReport.ReportPath = @"Reports\Equipment\CreditNote\Invoice_ExcDate.rdlc";
                }
                else
                {
                    ReportViewer1.LocalReport.ReportPath = @"Reports\Equipment\CreditNote\Invoice.rdlc"; ;
                }
            }
            else
            {
                if (chkNoDate.Checked && chkNoVat.Checked)
                {
                    ReportViewer1.LocalReport.ReportPath = @"Reports\Inventory\CreditNote\Invoice_ExcDateExcVat.rdlc";
                }
                else if (!chkNoDate.Checked && chkNoVat.Checked)
                {
                    ReportViewer1.LocalReport.ReportPath = @"Reports\Inventory\CreditNote\Invoice_ExcVat.rdlc";
                }
                else if (chkNoDate.Checked && !chkNoVat.Checked)
                {
                    ReportViewer1.LocalReport.ReportPath = @"Reports\Inventory\CreditNote\Invoice_ExcDate.rdlc";
                }
                else
                {
                    ReportViewer1.LocalReport.ReportPath = @"Reports\Inventory\CreditNote\Invoice.rdlc"; ;
                }
            }
            ...
            Response.AddHeader("content-disposition", "inline; filename= " + lblDetailCreditNoteNumber.Text + "." + extension);
